import{_ as N}from"./BCxCfwKJ.js";import{_ as $,o as f,c as h,b as n,w as p,d as i,n as d,t as c,f as k,g as m,a as g,i as e}from"./BRngrO-e.js";import{_ as v}from"./AViXIRVn.js";import{u,q as x}from"./ChYF1ofS.js";import"./OgMzJSjh.js";import"./CrEV8ema.js";import"./BLZ_LlLa.js";import"./KojG-Bha.js";const P={props:{paginatedItems:{type:Array,default:()=>[]},nextPage:{type:Boolean,default:!1},pageNo:{type:Number,default:0},allItems:{type:Array,default:()=>[]}},computed:{prevLink(){return this.pageNo===1?"/blog/1":`/blog/${this.pageNo-1}`}}},A={class:"mx-auto text-center"};function I(b,a,t,r,l,s){const o=N;return f(),h("div",A,[n(o,{to:s.prevLink,class:d(`
        px-2
        py-2
        text-xl
        text-white
