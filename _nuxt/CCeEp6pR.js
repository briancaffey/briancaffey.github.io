import{_ as C}from"./DOSkGhfy.js";import{e as h,k as d,c as w,o as $,b as s,d as r,n as _,i as a,w as c,t as u,_ as k,l as I,f,a as b}from"./BGVd3gTK.js";import{_ as D}from"./Ekncz210.js";import{u as y,q as N}from"./BV8beDzS.js";import"./DjpwRNo_.js";import"./CB8nuxxo.js";import"./CHEBxJxq.js";const P={class:"mx-auto text-center"},B=h({__name:"index",props:{paginatedItems:{type:Array,default:()=>[]},nextPage:{type:Boolean,default:!1},pageNo:{type:Number,default:0},allItems:{type:Array,default:()=>[]}},setup(o){const e=o,n=d(()=>e.pageNo===1?"/blog/1":`/blog/${e.pageNo-1}`);return(p,t)=>{const l=C;return $(),w("div",P,[s(l,{to:a(n),class:_(`
        px-2
        py-2
        text-xl
        text-white
