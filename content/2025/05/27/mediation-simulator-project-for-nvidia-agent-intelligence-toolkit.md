...
**Version Note:** This article was published in May 2025. As of March 2026, Qwen3.5 is available (the article references Qwen3-8b). The NVIDIA Agent Intelligence Toolkit and associated NIMs may have updated versions since publication. Check official documentation for the latest releases.
...
![Redis Memory Backend](/static/mediation-simulator/redis.png)
